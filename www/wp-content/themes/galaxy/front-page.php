            ...
            <div class="container">
                <div class="header-row">
                    ...
                    <div id="slidemenu">
                        ...
                        <ul id="menu-primary-menu" class="nav navbar-nav"><li id="nav-menu-item-1566" class="main-menu-item  menu-item-even menu-item-depth-0 menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-56 current_page_item"><a href="https://smartdata.tonytemplates.com/car-repair-service/car2/" class="menu-link main-menu-link">Home</a></li>
...
<li id="nav-menu-item-1568" class="main-menu-item  menu-item-even menu-item-depth-0 menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children dropdown"><a href="https://smartdata.tonytemplates.com/car-repair-service/car2/services/" class="menu-link main-menu-link">Services<span class="ecaret"></span></a>
<ul class="dropdown-menu menu-odd  menu-depth-1">
	<li id="nav-menu-item-1521" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-post_type menu-item-object-car_services"><a href="https://smartdata.tonytemplates.com/car-repair-service/car2/car-services/automatic-updatesand-unlock/" class="menu-link sub-menu-link">Preventative Maintenance</a></li>
...
<li id="nav-menu-item-1565" class="main-menu-item  menu-item-even menu-item-depth-0 menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children dropdown"><a href="https://smartdata.tonytemplates.com/car-repair-service/car2/blog/" class="menu-link main-menu-link">Blog<span class="ecaret"></span></a>
<ul class="dropdown-menu menu-odd  menu-depth-1">
	<li id="nav-menu-item-1577" class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-post_type menu-item-object-page"><a href="https://smartdata.tonytemplates.com/car-repair-service/car2/blog/" class="menu-link sub-menu-link">Blog Classic</a></li>
